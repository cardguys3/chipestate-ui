...
// ==== BLOCK: Imports and Setup END ====

// ==== BLOCK: Chart Options Setup START ====
ChartJS.register(
  LineElement,
  BarElement,
  CategoryScale,
...
// ==== BLOCK: Dashboard Page State Setup START ====
...
// ==== BLOCK: Dashboard Page State Setup END ====


// ==== BLOCK: Dashboard Page Data Loading (useEffect) START ====
...
// ==== BLOCK: Dashboard Page Data Loading (useEffect) END ====


// ==== BLOCK: Utility - Color Palette Helper START ====
  const getColor = (i: number) => {
    const colors = ['#10B981', '#3B82F6', '#F59E0B', '#EF4444', '#6366F1', '#EC4899', '#14B8A6', '#F97316']
    return colors[i % colors.length]
  }
// ==== BLOCK: Utility - Color Palette Helper END ====


// ==== BLOCK: Earnings Filtering & Aggregation START ====
...
// ==== BLOCK: Earnings Filtering & Aggregation END ====


// ==== BLOCK: Chart Data Construction START ====
...
// ==== BLOCK: Chart Data Construction END ====


// ==== BLOCK: Chart Dataset Initialization START ====
...
// ==== BLOCK: Chart Dataset Initialization END ====


// ==== BLOCK: Conditional Return (User Not Ready) START ====
...
// ==== BLOCK: Conditional Return (User Not Ready) END ====


// ==== BLOCK: Dashboard Header & Quick Links START ====
  return (
    <>
      <main className="min-h-screen bg-[#0e1a2b] text-white p-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
          ...
          <div className="flex flex-wrap gap-2 items-center">
            ...
            {[{ label: 'Account', href: '/account' }, { label: 'Trade Chips', href: '/trade' }, { label: 'Sell Chips', href: '/trade/list' }, { label: 'Open Votes', href: '/votes/history' }].map(({ label, href }) => (
...
// ==== BLOCK: Dashboard Header & Quick Links END ====


// ==== BLOCK: Dashboard Badges Section START ====
      {userBadges.length > 0 && (
...
// ==== BLOCK: Dashboard Badges Section END ====
...
// ==== BLOCK: Performance Stats Cards – Grid CONTINUED ====
